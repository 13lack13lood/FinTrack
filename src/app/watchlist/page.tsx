		...
		<div className="flex flex-col items-center justify-center w-max mx-auto p-4 space-y-7">
			...
			{docData &&
				(docData.length > 0 ? (
					docData.map(async (ticker: string) => {
						...
						return (
							<div className="grid grid-cols-8 items-center w-full">
								...
								<Link
									href={"/stocks/" + ticker}
									className="col-span-7 flex flex-row w-full items-center group justify-end cursor-pointer "
								>
									<div className="grid grid-cols-7 gap-4 w-full items-center bg-bgcolor-primary drop-shadow-bg-light rounded-2xl py-4 transition-all duration-200 group-hover:-translate-x-5 group-hover:bg-accent tracking-wide">
										<div className="text-white text-2xl text-center px-6 mx-1">
											{ticker.toUpperCase()}
										</div>
										<div className="text-white text-lg font-light text-center px-6 mx-1">
										...
										<div className="text-white text-lg font-light text-center col-span-2 px-6 mx-1">
					...
					<div className="w-full text-white text-2xl text-center my-20 ">
