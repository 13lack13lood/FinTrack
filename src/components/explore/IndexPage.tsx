    ...
    return (
        <div className="flex flex-col justify-center p-6 space-y-7">
            <div className="flex flex-wrap justify-center items-center space-x-10">
                <div
                    className={`${currentIndex == "^GSPC" ? "bg-accent" : "bg-bgcolor-primary"} text-white text-xl rounded-full font-light px-4 py-2 capitalize drop-shadow-bg transition-all duration-200 hover:bg-accent`}
                    onClick={() => setCurrentIndex("^GSPC")}
                >
                    S&P 500
                </div>
                <div
                    className={`${currentIndex == "^DJI" ? "bg-accent" : "bg-bgcolor-primary"} text-white text-xl rounded-full font-light px-4 py-2 capitalize drop-shadow-bg transition-all duration-200 hover:bg-accent`}
                    onClick={() => setCurrentIndex("^DJI")}
                >
                    Dow Jones
                </div>
                <div
                    className={`${currentIndex == "^IXIC" ? "bg-accent" : "bg-bgcolor-primary"} text-white text-xl rounded-full font-light px-4 py-2 capitalize drop-shadow-bg transition-all duration-200 hover:bg-accent`}
            ...
            {indexDataLoaded && indexData ? (
                <div className="flex flex-col items-center px-4 space-y-4">
                    <div className="flex flex-col items-center w-[650px] h-fit bg-bgcolor-primary space-y-6 py-6 rounded-xl drop-shadow-bg-light">
                    ...
                    <div className="flex flex-col w-3/4 text-white justify-center pt-7">
                        <div className="text-2xl border-b-2 text-center border-accent p-4 capitalize mb-5">About the {indexData.name}</div>
                        <div className="text-lg font-light ">
                            {indexData.wiki.text}
                            <a className="transition-all duration-200 hover:text-accent" href={indexData.wiki.url} target="_blank">
                                [Read More]
                            </a>
                        </div>
                    </div>
