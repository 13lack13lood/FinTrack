		...
		<div className="flex flex-wrap w-full items-center justify-center space-x-7">
			<div className="grid grid-cols-2 gap-4">
				{Object.entries(info).map(([key, value]) => {
					return (
						<div className="flex flex-col items-start p-4 space-y-3 bg-bgcolor-primary rounded-2xl drop-shadow-bg">
			...
			<div className="flex flex-col w-1/3 bg-bgcolor-primary p-4 rounded-2xl drop-shadow-bg">
				...
				<div className="text-white font-light">
					...
					<a
						href={wiki.url}
						className="underline transition-all duration-150 hover:text-accent"
						target="_blank"
					>
						[Read More]
					</a>
