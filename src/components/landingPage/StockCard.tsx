...
const StockCard = ({ stock }: Props) => {
	return (
		<Link href={`/stocks/${stock.ticker}`}>
			<div className="group drop-shadow-bg block relative w-full h-full bg-bgcolor-primary rounded-2xl p-6 overflow-hidden border-2 border-bgcolor-primary hover:border-accent transition ease-in hover:cursor-pointer">
